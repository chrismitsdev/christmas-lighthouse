...
function Input({
  ...
  return (
    ...
    >
      <input
        className={cn(
          'px-4 py-3.75 block w-full bg-brand-gray-12 text-brand-gray-1 border border-transparent rounded outline-none duration-300 placeholder:text-sm placeholder:text-brand-gray-11 disabled:opacity-30 group-focus-within:border-brand-gray-11 sm:placeholder:text-base',
          icon && 'pl-8 sm:pl-12',
